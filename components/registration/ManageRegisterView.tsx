...
export const ManageRegisterView: React.FC<ManageRegisterViewProps> = ({
  ...
  const getIntakeTypePill = (type: string) => {
    switch (type) {
      case 'INITIAL_REGISTRATION':
        return <span className="bg-blue-50 text-blue-700 font-bold text-[10px] px-2.5 py-1 rounded-full border border-blue-200/60">INITIAL</span>;
      case 'RE_REGISTRATION':
        return <span className="bg-purple-50 text-purple-700 font-bold text-[10px] px-2.5 py-1 rounded-full border border-purple-200/60">RE-REGISTRATION</span>;
      case 'TRANSFER':
        return <span className="bg-teal-50 text-teal-700 font-bold text-[10px] px-2.5 py-1 rounded-full border border-teal-200/60">TRANSFER</span>;
      case 'PROGRAM_PROGRESSION':
      default:
        return <span className="bg-amber-50 text-amber-700 font-bold text-[10px] px-2.5 py-1 rounded-full border border-amber-200/60">PROGRESSION</span>;
    }
  };
  ...
  const getStatusBadge = (status: WorkflowStatus) => {
    switch (status) {
      case 'APPROVED':
        return (
          <span className="bg-[#e6fcf5] text-[#0d9488] border border-emerald-200 px-2.5 py-1 rounded-full font-bold text-[10px] inline-flex items-center gap-1.5 whitespace-nowrap">
      ...
      case 'UNDER_REVIEW':
        return (
          <span className="bg-blue-50 text-blue-700 border border-blue-200 px-2.5 py-1 rounded-full font-bold text-[10px] inline-flex items-center gap-1.5 whitespace-nowrap">
      ...
      case 'CORRECTION_REQUIRED':
        return (
          <span className="bg-rose-50 text-rose-600 border border-rose-200 px-2.5 py-1 rounded-full font-bold text-[10px] inline-flex items-center gap-1.5 whitespace-nowrap">
      ...
      case 'SUBMITTED':
        return (
          <span className="bg-indigo-50 text-indigo-700 border border-indigo-200 px-2.5 py-1 rounded-full font-bold text-[10px] inline-flex items-center gap-1.5 whitespace-nowrap">
      ...
      case 'RESUBMITTED':
        return (
          <span className="bg-cyan-50 text-cyan-700 border border-cyan-200 px-2.5 py-1 rounded-full font-bold text-[10px] inline-flex items-center gap-1.5 whitespace-nowrap">
      ...
      case 'ARCHIVED':
        return (
          <span className="bg-slate-100 text-slate-700 border border-slate-300 px-2.5 py-1 rounded-full font-bold text-[10px] inline-flex items-center gap-1.5 whitespace-nowrap">
      ...
      default:
        return (
          <span className="bg-slate-100 text-slate-600 border border-slate-200 px-2.5 py-1 rounded-full font-bold text-[10px] inline-flex items-center gap-1.5 whitespace-nowrap">
    ...
    <div className="space-y-6 pb-20 relative">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
        ...
        <div className="hidden lg:grid grid-cols-12 gap-3 px-5 py-3 bg-slate-50/70 border-b border-slate-100 text-[10px] font-bold uppercase tracking-wider text-slate-400">
          ...
          <div className="col-span-1">Intake Type</div>
            ...
            {paginatedRegistrations.map((reg) => {
              ...
              return (
                <div
                  ...
                  className={`grid grid-cols-1 lg:grid-cols-12 gap-3 items-center px-5 py-4 transition-colors hover:bg-slate-50/70 cursor-pointer ${
                ...
                >
                  ...
                  {/* Academic Program */}
                  <div className="lg:col-span-3 space-y-0.5 truncate">
                    <p className="font-bold text-xs text-slate-900 truncate">
