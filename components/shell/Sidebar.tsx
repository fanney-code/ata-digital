      ...
      >
        ...
        <div className="p-4 shrink-0">
          {currentRole === 'UNIVERSAL' ? (
            ...
            <div className="p-4 rounded-2xl bg-[#eff4ff] flex flex-col gap-4">
              {/* Active Affiliate Header */}
              ...
              <div className="flex items-center justify-between pt-2 border-t border-blue-100/60">
                ...
                <button
                  type="button"
                  onClick={handleLogout}
                  className="flex items-center gap-1.5 text-xs font-bold text-[#c13536] hover:text-red-700 transition-colors"
                >
                  <LogOut className="h-4 w-4 text-[#c13536]" />
                  <span>Sign Out</span>
                </button>
              </div>
            </div>
